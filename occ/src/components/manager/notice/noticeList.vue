<template>
  <div class="publicList">
    <div class="publicTitle">通知管理</div>
    <div class="publicListTable">
      <div class="publicList_Head">
        <div class="publicList_Head_Bt">
          <el-button @click="jumpTo('/manager/noticeForm/add')" style="background-color: lightblue" v-if="hasPermission('notice_add')">新增</el-button>
            <el-button @click="displayInfo" style="background-color: #ccc">刷新</el-button>
          <el-button @click="deleteAll" style="background-color: #ff000096" v-if="hasPermission('notice_delete')">批量删除</el-button>
        </div>
      ...
      <el-table :data="datas.list" ref="table">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button @click="del(scope.row.id)" type="text" size="mid" v-if="hasPermission('notice_delete')">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  export default{
    ...
    methods: {
      ...
      edit: function(id){
        this.$router.push('/manager/noticeForm/edit/' + id);
      },
      dis: function(id){
