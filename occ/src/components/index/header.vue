<template>
  <div class="head">
    ...
    <div class="login">
      <span :class="{redColor:this.$route.name == route[1].name}" @click="jumpTo(route[1].url)">登录</span>
      <span :class="{redColor:this.$route.name == route[2].name}" @click="jumpTo(route[2].url)">注册</span>
